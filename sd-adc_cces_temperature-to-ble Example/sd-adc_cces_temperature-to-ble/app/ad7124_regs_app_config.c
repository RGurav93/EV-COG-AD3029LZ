/*!
 *****************************************************************************
  @file:  ad7124_regs_app_config.c

  @brief: Default register configuration for AD7124 application
...
struct ad7124_st_reg ad7124_regs_app_evb[AD7124_REG_NO] = {
	{0x00, 0x00,   1, 2}, /* AD7124_Status */
	{0x01, 0x1400, 2, 1}, /* AD7124_ADC_Control */			// Enable DATA_STATUS to append status, Set DOUTRDYB delay to ~100ns
	...
	{0x0A, 0x8403, 2, 1}, /* AD7124_Channel_1 */
	{0x0B, 0x8805, 2, 1}, /* AD7124_Channel_2 */
